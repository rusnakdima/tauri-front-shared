...
class ModalComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    isStandalone: true,
    selector: "app-modal",
    inputs: { open: "open", title: "title", size: "size" },
...
class LoadingComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    isInline: true,
    styles: [
      ":host{display:inline-flex;align-items:center;justify-content:center}.spinner{border:2px solid var(--border-color);border-top-color:var(--accent);border-radius:50%;animation:spin .7s linear infinite}.spinner-sm{width:16px;height:16px;border-width:2px}.spinner-md{width:32px;height:32px;border-width:3px}.spinner-lg{width:48px;height:48px;border-width:4px}@keyframes spin{to{transform:rotate(360deg)}}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class RadioComponent {
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:inline-flex;align-items:center}label{display:flex;align-items:center;gap:.5rem;cursor:pointer}input[type=radio]{width:1rem;height:1rem;accent-color:var(--accent);cursor:pointer}input[type=radio]:disabled{cursor:not-allowed;opacity:.5}.radio-label{color:var(--text-primary);font-size:.875rem;-webkit-user-select:none;user-select:none}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class SliderComponent {
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:block}.slider-wrapper{width:100%}input[type=range]{width:100%;accent-color:var(--accent);cursor:pointer}input[type=range]:disabled{opacity:.5;cursor:not-allowed}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class SwitchComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    isStandalone: true,
    selector: "app-switch",
    inputs: { checked: "checked", label: "label", disabled: "disabled" },
    outputs: { changed: "changed" },
    ngImport: i0,
    template: `
...
class SelectComponent {
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:inline-flex}select{display:inline-flex;align-items:center;padding:.5rem 1rem;border-radius:.5rem;border:1px solid var(--border-color);background-color:var(--bg-elevated);color:var(--text-primary);font-size:1rem;font-weight:500;cursor:pointer;transition:all .15s;min-width:150px}select:hover:not(:disabled){background-color:var(--bg-hover)}select:disabled{opacity:.5;cursor:not-allowed}select:focus{outline:none;border-color:var(--accent)}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class CardComponent {
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:block}.card{background-color:var(--bg-elevated);border:1px solid var(--border-color);border-radius:.5rem;overflow:hidden;transition:box-shadow .15s}.card-elevated{box-shadow:0 4px 6px -1px #0000001a,0 2px 4px -1px #0000000f}.card-header{padding:1rem;border-bottom:1px solid var(--border-color)}.card-title{margin:0;font-size:1rem;font-weight:600;color:var(--text-primary)}.card-content{padding:1rem;color:var(--text-secondary);font-size:.875rem;line-height:1.5}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class DataTableComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    inputs: { columns: "columns", data: "data", selectable: "selectable" },
...
class JsonViewComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    isInline: true,
    styles: [
      ":host{display:block}.json-container{background-color:var(--bg-secondary);border:1px solid var(--border-color);border-radius:.5rem;padding:1rem;font-family:monospace;font-size:.875rem;overflow-x:auto;white-space:pre-wrap;word-break:break-word}.json-key{color:var(--accent)}.json-string{color:var(--success)}.json-number{color:var(--warning)}.json-boolean{color:var(--error)}.json-null{color:var(--text-muted)}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class ComponentPaletteComponent {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    version: "20.3.25",
    ngImport: i0,
    type: ComponentPaletteComponent,
    deps: [],
    target: i0.ɵɵFactoryTarget.Component,
  });
  static ɵcmp = i0.ɵɵngDeclareComponent({
...
class CanvasComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    outputs: { elementSelected: "elementSelected" },
    ngImport: i0,
    template: `
...
class PropertiesPanelComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    outputs: { propertyChange: "propertyChange" },
    usesOnChanges: true,
    ngImport: i0,
    template: `
...
class FooterComponent {
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:block}footer{display:flex;align-items:center;justify-content:center;padding:1rem;background:var(--bg-elevated);border-top:1px solid var(--border-color);min-height:48px}.footer-text{margin:0;font-size:.875rem;color:var(--text-secondary);text-align:center}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class SplitViewComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    outputs: { splitChanged: "splitChanged" },
    viewQueries: [
      {
...
class AvatarComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    isStandalone: true,
    selector: "app-avatar",
    inputs: { src: "src", alt: "alt", size: "size" },
    ngImport: i0,
    template: `
    @if (src && !imgError) {
  ...
  `,
    isInline: true,
    styles: [
      ':host{display:inline-flex;align-items:center;justify-content:center;border-radius:50%;overflow:hidden;background-color:var(--bg-elevated);border:1px solid var(--border-color)}:host([size="sm"]){width:2rem;height:2rem;font-size:.75rem}:host([size="md"]){width:2.5rem;height:2.5rem;font-size:.875rem}:host([size="lg"]){width:3.5rem;height:3.5rem;font-size:1.25rem}img{width:100%;height:100%;object-fit:cover}.initials{font-weight:600;color:var(--text-secondary);text-transform:uppercase}\n',
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class ChipComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    isStandalone: true,
    selector: "app-chip",
    inputs: { label: "label", icon: "icon", removable: "removable" },
...
class PaginationComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    inputs: { page: "page", total: "total", pageSize: "pageSize" },
...
class TabsComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    isStandalone: true,
    selector: "app-tabs",
    inputs: { tabs: "tabs", activeTab: "activeTab" },
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:block}.tabs{display:flex;gap:0;border-bottom:1px solid var(--border-color)}.tab{padding:.75rem 1.25rem;font-size:.875rem;font-weight:500;color:var(--text-secondary);cursor:pointer;border-bottom:2px solid transparent;margin-bottom:-1px;transition:all .15s}.tab:hover{color:var(--text-primary)}.tab.active{color:var(--accent);border-bottom-color:var(--accent)}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class SegmentSelectorComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    inputs: { options: "options", selected: "selected" },
    outputs: { changed: "changed" },
    ngImport: i0,
    template: `
...
class TooltipComponent {
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:inline-flex;position:relative}.tooltip-trigger{display:inline-flex;position:relative;cursor:pointer}.tooltip-bubble{position:absolute;z-index:1000;padding:.375rem .75rem;border-radius:.375rem;background:var(--bg-elevated);color:var(--text-primary);font-size:.75rem;white-space:nowrap;border:1px solid var(--border-color);box-shadow:0 4px 6px #0000001a;pointer-events:none}.tooltip-bubble.top{bottom:100%;left:50%;transform:translate(-50%);margin-bottom:.5rem}.tooltip-bubble.bottom{top:100%;left:50%;transform:translate(-50%);margin-top:.5rem}.tooltip-bubble.left{right:100%;top:50%;transform:translateY(-50%);margin-right:.5rem}.tooltip-bubble.right{left:100%;top:50%;transform:translateY(-50%);margin-left:.5rem}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class SnackbarComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    outputs: { dismissed: "dismissed", actioned: "actioned" },
    usesOnChanges: true,
    ngImport: i0,
    template: `
    @if (open) {
...
class TreeNodeComponent {
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:block}.tree-node{display:flex;align-items:center;gap:.375rem;padding:.25rem .5rem;cursor:pointer;border-radius:.25rem;transition:background-color .15s}.tree-node:hover{background-color:var(--bg-hover)}.tree-node.selected{background-color:var(--accent);color:var(--text-on-accent)}.toggle{font-size:.625rem;width:1rem;text-align:center;flex-shrink:0;cursor:pointer;color:var(--text-secondary)}.toggle-placeholder{width:1rem;flex-shrink:0}.node-icon{font-size:1rem;flex-shrink:0;color:var(--text-secondary)}.node-label{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}\n",
    ],
    dependencies: [
      {
        kind: "component",
...
class TreeComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    isStandalone: true,
    selector: "app-tree",
    inputs: { nodes: "nodes", selectable: "selectable" },
    outputs: { selected: "selected" },
    ngImport: i0,
    template: `
...
class CheckboxComponent {
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:inline-flex;align-items:center}label{display:flex;align-items:center;gap:.5rem;cursor:pointer}input[type=checkbox]{width:1rem;height:1rem;accent-color:var(--accent);cursor:pointer}input[type=checkbox]:disabled{cursor:not-allowed;opacity:.5}.checkbox-label{color:var(--text-primary);font-size:.875rem;-webkit-user-select:none;user-select:none}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class ToastComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    isStandalone: true,
    selector: "app-toast",
    inputs: { message: "message", visible: "visible", type: "type" },
...
class DesignerSidebarComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    inputs: { position: "position", collapsed: "collapsed", header: "header" },
...
class MainEditorComponent {
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:block;height:100%}.main-editor{height:100%;display:flex;align-items:center;justify-content:center;background:var(--bg-primary);color:var(--text-secondary);font-family:system-ui,sans-serif}.placeholder{text-align:center;padding:2rem}.placeholder-icon{font-size:3rem;margin-bottom:.5rem;opacity:.3}.placeholder-text{font-size:.875rem}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class CommandPaletteComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    outputs: { commandSelected: "commandSelected", closed: "closed" },
...
class SwapButtonComponent {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    isInline: true,
    styles: [
      ":host{display:inline-flex}.swap-btn{display:flex;align-items:center;justify-content:center;width:40px;height:40px;border-radius:50%;border:1px solid var(--border-color);background:var(--bg-elevated);color:var(--text-secondary);cursor:pointer;transition:all .15s;padding:0}.swap-btn:hover{background:var(--bg-hover);color:var(--text-primary)}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class TranslationOutputComponent {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    version: "20.3.25",
    ngImport: i0,
    type: TranslationOutputComponent,
    deps: [],
    target: i0.ɵɵFactoryTarget.Component,
  });
  static ɵcmp = i0.ɵɵngDeclareComponent({
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:block;position:relative}.output-wrapper{position:relative}.output-textarea{width:100%;padding:.75rem;border-radius:.5rem;border:1px solid var(--border-color);background-color:var(--bg-primary);color:var(--text-primary);box-sizing:border-box;font-family:inherit;resize:none;min-height:80px;cursor:default}.output-textarea::placeholder{color:var(--text-muted)}.copy-btn{position:absolute;right:.5rem;top:.5rem;display:flex;align-items:center;gap:.25rem;padding:.375rem .5rem;border-radius:.375rem;border:1px solid var(--border-color);background:var(--bg-elevated);color:var(--text-secondary);cursor:pointer;transition:all .15s;font-size:.75rem}.copy-btn:hover{background:var(--bg-hover);color:var(--text-primary)}.copied-text{color:var(--success)}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class ThemeToggleComponent {
  ...
  `,
    isInline: true,
    styles: [
      ":host{display:inline-flex}.theme-toggle{display:flex;align-items:center;justify-content:center;width:40px;height:40px;border-radius:50%;border:1px solid var(--border-color);background:transparent;color:var(--text-secondary);cursor:pointer;transition:all .15s;padding:0}.theme-toggle:hover{background:var(--bg-hover);color:var(--text-primary)}\n",
    ],
  });
}
i0.ɵɵngDeclareClassMetadata({
...
class ShortcutsOverlayComponent {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    version: "20.3.25",
    ngImport: i0,
    type: ShortcutsOverlayComponent,
    deps: [],
    target: i0.ɵɵFactoryTarget.Component,
  });
  static ɵcmp = i0.ɵɵngDeclareComponent({
...
class DataBindingResolverService {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    deps: [{ token: SignalStoreService }, { token: CrudService$1 }],
    target: i0.ɵɵFactoryTarget.Injectable,
  });
  static ɵprov = i0.ɵɵngDeclareInjectable({
    minVersion: "12.0.0",
...
class SchemaRendererService {
  ...
  _handlers = {};
  _stores = {};
  _layoutRegions = signal(
    [],
    ...(ngDevMode ? [{ debugName: "_layoutRegions" }] : []),
  );
  _currentRoute = signal(
    "",
    ...(ngDevMode ? [{ debugName: "_currentRoute" }] : []),
  );
  ...
  loadSchema(schema) {
    ...
    // Extract app config
    const appConfig =
      "app" in schema ? schema.app : "app" in schema ? schema.app : undefined;
    this._appConfig = {
  ...
  mapPropsToClasses(
    ...
    const gap = props["gap"];
    if (gap === "xs" || gap === 1) classes.push("gap-1");
    else if (gap === "sm" || gap === 2) classes.push("gap-2");
    else if (gap === "md" || gap === 3) classes.push("gap-3");
    else if (gap === "lg" || gap === 4) classes.push("gap-4");
    else if (gap === "xl" || gap === 6) classes.push("gap-6");
    else if (gap === "2xl" || gap === 8) classes.push("gap-8");
    // 5. Align items
    ...
    else if (maxWidth === "3xl") classes.push("max-w-3xl");
    else if (maxWidth === "6xl") classes.push("max-w-6xl");
    else if (maxWidth === "7xl") classes.push("max-w-7xl");
    // 10. MX auto
    const mx = props["mx"];
    ...
    if (textSize === "xs") classes.push("text-xs");
    else if (textSize === "sm") classes.push("text-sm");
    else if (textSize === "base") classes.push("text-base");
    else if (textSize === "lg") classes.push("text-lg");
    else if (textSize === "xl") classes.push("text-xl");
    else if (textSize === "2xl") classes.push("text-2xl");
    else if (textSize === "3xl") classes.push("text-3xl");
    // 33. Font weight
    const fontWeight = props["fontWeight"];
    if (fontWeight === "light") classes.push("font-light");
    else if (fontWeight === "normal") classes.push("font-normal");
    else if (fontWeight === "medium") classes.push("font-medium");
    else if (fontWeight === "semibold") classes.push("font-semibold");
    ...
    if (zIndex === 10 || zIndex === "10") classes.push("z-10");
    else if (zIndex === 20 || zIndex === "20") classes.push("z-20");
    else if (zIndex === 30 || zIndex === "30") classes.push("z-30");
    else if (zIndex === 40 || zIndex === "40") classes.push("z-40");
    else if (zIndex === 50 || zIndex === "50") classes.push("z-50");
    return classes;
  }
...
class SchemaRouterService {
  ...
  _currentPage = signal(
    null,
    ...(ngDevMode ? [{ debugName: "_currentPage" }] : []),
  );
  _currentLayout = signal(
    null,
    ...(ngDevMode ? [{ debugName: "_currentLayout" }] : []),
  );
  _currentRoute = signal(
    "",
    ...(ngDevMode ? [{ debugName: "_currentRoute" }] : []),
  ...
  hasSchema = computed(
    () => this._schema() !== null,
    ...(ngDevMode ? [{ debugName: "hasSchema" }] : []),
  );
  currentPageId = computed(
    () => this._currentPage()?.id ?? null,
      ...
      if (page && this.guardService) {
        ...
        if (pageGuards?.length) {
          for (const guard of pageGuards) {
            const allowed =
              await this.guardService.canActivateWithConfig(guard);
            if (!allowed) {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    deps: [{ token: GuardService, optional: true }],
    target: i0.ɵɵFactoryTarget.Injectable,
  });
  static ɵprov = i0.ɵɵngDeclareInjectable({
    minVersion: "12.0.0",
...
class SchemaShellComponent {
  ...
  async loadSchema() {
    ...
    try {
      ...
      const originalMessage =
        err instanceof Error
          ...
          : typeof err === "object" && err
            ? String(err["message"] ?? Object.values(err)[0] ?? String(err))
            : String(err);
      ...
      const fallbackSchema =
        this.fallbackService.getFallbackSchema(originalMessage);
      this.schemaRouter.setSchema(fallbackSchema);
      this.renderer.loadSchema(fallbackSchema);
      await this.schemaRouter.navigate("/schema-error");
    } finally {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    version: "20.3.25",
    ngImport: i0,
    type: SchemaShellComponent,
    deps: [
      { token: InvokeWrapperService },
      { token: SchemaRouterService },
      { token: SchemaRendererService },
      { token: StyleThemeService },
      { token: ThemeToggleService },
      { token: FallbackService },
    ],
    target: i0.ɵɵFactoryTarget.Component,
  });
  static ɵcmp = i0.ɵɵngDeclareComponent({
...
class GlobalStateService {
  ...
  _sourceLang = signal(
    "en",
    ...(ngDevMode ? [{ debugName: "_sourceLang" }] : []),
  );
  _targetLang = signal(
    "ru",
    ...(ngDevMode ? [{ debugName: "_targetLang" }] : []),
  );
  _appLocale = signal(
    "en",
    ...(ngDevMode ? [{ debugName: "_appLocale" }] : []),
  );
  get sourceLang() {
...
class ErrorHandlerService {
  toastService;
  errorLogSignal = signal(
    [],
    ...(ngDevMode ? [{ debugName: "errorLogSignal" }] : []),
  );
  onlineSignal = signal(
    navigator.onLine,
    ...(ngDevMode ? [{ debugName: "onlineSignal" }] : []),
  );
  retryCounter = 0;
  errorLog = computed(
    () => this.errorLogSignal(),
    ...(ngDevMode ? [{ debugName: "errorLog" }] : []),
  );
  isOnline = computed(
    () => this.onlineSignal(),
    ...(ngDevMode ? [{ debugName: "isOnline" }] : []),
  );
  errorCount = computed(
...
class UnifiedStorageService {
  ...
  async find(filter) {
    const all = this.signalStore.keys().map((k) => this.signalStore.get(k));
