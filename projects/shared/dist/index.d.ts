...
import { OnDestroy, OnInit, OnChanges, SimpleChanges, Type, TemplateRef, ViewContainerRef } from '@angular/core';
...
declare class SchemaShellComponent implements OnInit {
    ...
    constructor(invokeWrapper: InvokeWrapperService, schemaRouter: SchemaRouterService, renderer: SchemaRendererService, themeService: StyleThemeService, themeToggle: ThemeToggleService, fallbackService: FallbackService);
